...
public class Constans {
    ...
    public static final String BENEFIT_PRACTICE = "To include good practices\n" +
            "and ideas from successful\n" +
            "EPAM projec";
    public static final String BENEFIT_CUSTOM = "To be flexible and\n" +
            "customizable";
    public static final String BENEFIT_MULTI = "To be multiplatform";
    public static final String BENEFIT_BASE = "Already have good base\n" +
